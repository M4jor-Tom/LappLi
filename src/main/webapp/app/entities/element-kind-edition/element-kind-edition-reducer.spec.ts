...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './element-kind-edition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELEMENTKINDEDITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ELEMENTKINDEDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ELEMENTKINDEDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ELEMENTKINDEDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ELEMENTKINDEDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ELEMENTKINDEDITION actions', async () => {
      const expectedActions = [
        {
