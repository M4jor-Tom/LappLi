...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './strip.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRIP actions', async () => {
      const expectedActions = [
        {
