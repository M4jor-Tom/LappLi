...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <ErrorBoundaryRoute path={`${match.url}my-new-component`} component={MyNewComponent} />
      <ErrorBoundaryRoute path={`${match.url}my-new-component-supply`} component={MyNewComponentSupply} />
