...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLYPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
