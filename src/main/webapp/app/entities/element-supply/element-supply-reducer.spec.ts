...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELEMENTSUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ELEMENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ELEMENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ELEMENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ELEMENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ELEMENTSUPPLY actions', async () => {
      const expectedActions = [
        {
