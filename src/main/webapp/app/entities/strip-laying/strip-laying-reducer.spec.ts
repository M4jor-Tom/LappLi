...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRIPLAYING_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRIPLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRIPLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRIPLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRIPLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRIPLAYING actions', async () => {
      const expectedActions = [
        {
