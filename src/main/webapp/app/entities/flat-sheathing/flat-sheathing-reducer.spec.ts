...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLATSHEATHING_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLATSHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLATSHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLATSHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLATSHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLATSHEATHING actions', async () => {
      const expectedActions = [
        {
