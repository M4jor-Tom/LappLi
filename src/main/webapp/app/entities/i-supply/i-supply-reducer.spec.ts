...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './i-supply.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ISUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISUPPLY actions', async () => {
      const expectedActions = [
        {
