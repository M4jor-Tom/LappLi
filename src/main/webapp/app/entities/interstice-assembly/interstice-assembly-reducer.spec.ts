...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './interstice-assembly.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERSTICEASSEMBLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERSTICEASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERSTICEASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERSTICEASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERSTICEASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERSTICEASSEMBLY actions', async () => {
      const expectedActions = [
        {
