...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYNEWOPERATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYNEWOPERATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYNEWOPERATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYNEWOPERATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYNEWOPERATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYNEWOPERATION actions', async () => {
      const expectedActions = [
        {
