...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEELFIBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEELFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEELFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEELFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEELFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEELFIBER actions', async () => {
      const expectedActions = [
        {
