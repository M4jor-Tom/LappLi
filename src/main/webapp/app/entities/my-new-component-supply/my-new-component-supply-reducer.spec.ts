...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './my-new-component-supply.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYNEWCOMPONENTSUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYNEWCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYNEWCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYNEWCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYNEWCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYNEWCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
