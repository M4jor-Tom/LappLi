...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './continuity-wire-longit-laying.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTINUITYWIRELONGITLAYING_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTINUITYWIRELONGITLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTINUITYWIRELONGITLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTINUITYWIRELONGITLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTINUITYWIRELONGITLAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTINUITYWIRELONGITLAYING actions', async () => {
      const expectedActions = [
        {
