...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bangle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANGLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANGLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANGLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANGLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANGLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANGLE actions', async () => {
      const expectedActions = [
        {
