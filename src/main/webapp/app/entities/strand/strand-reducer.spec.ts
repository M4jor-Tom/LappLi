...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './strand.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRAND_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRAND actions', async () => {
      const expectedActions = [
        {
