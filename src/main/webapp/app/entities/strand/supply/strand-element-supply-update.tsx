...
import { getEntity, updateEntity, createEntity, reset } from '../../element-supply/element-supply.reducer';
...
export const StrandElementSupplyUpdate = (props: RouteComponentProps<{ element_supply_id: string; strand_id: string }>) => {
  ...
  const [isNew] = useState(!props.match.params || !props.match.params.element_supply_id);
  ...
  useEffect(() => {
    if (isNew) {
      ...
      dispatch(getEntity(props.match.params.element_supply_id));
    }
...
export default StrandElementSupplyUpdate;
