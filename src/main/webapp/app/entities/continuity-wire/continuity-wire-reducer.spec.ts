...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTINUITYWIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTINUITYWIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTINUITYWIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTINUITYWIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTINUITYWIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTINUITYWIRE actions', async () => {
      const expectedActions = [
        {
