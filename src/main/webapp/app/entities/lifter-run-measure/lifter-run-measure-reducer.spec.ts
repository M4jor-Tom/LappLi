...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './lifter-run-measure.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIFTERRUNMEASURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIFTERRUNMEASURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIFTERRUNMEASURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIFTERRUNMEASURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIFTERRUNMEASURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIFTERRUNMEASURE actions', async () => {
      const expectedActions = [
        {
