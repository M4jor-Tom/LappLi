...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sheathing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHEATHING_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHEATHING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHEATHING actions', async () => {
      const expectedActions = [
        {
