...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tape-kind.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAPEKIND_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAPEKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAPEKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAPEKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAPEKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAPEKIND actions', async () => {
      const expectedActions = [
        {
