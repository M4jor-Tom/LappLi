...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPPERFIBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPPERFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPPERFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPPERFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPPERFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPPERFIBER actions', async () => {
      const expectedActions = [
        {
