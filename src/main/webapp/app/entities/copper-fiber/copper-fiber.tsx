          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="lappLiApp.copperFiber.metalFiberKind">Metal Fiber Kind</Translate>
                </th>
                <th>
            ...
            <tbody>
              {copperFiberList.map((copperFiber, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`lappLiApp.MetalFiberKind.${copperFiber.metalFiberKind}`} />
                  </td>
