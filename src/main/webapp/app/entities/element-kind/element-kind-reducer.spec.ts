...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELEMENTKIND_LIST actions', async () => {
    ...
    it('dispatches FETCH_ELEMENTKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ELEMENTKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ELEMENTKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ELEMENTKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ELEMENTKIND actions', async () => {
      const expectedActions = [
        {
