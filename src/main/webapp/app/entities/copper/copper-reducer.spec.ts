...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './copper.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COPPER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COPPER actions', async () => {
      const expectedActions = [
        {
