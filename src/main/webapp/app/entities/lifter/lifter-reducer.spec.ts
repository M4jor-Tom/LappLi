...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lifter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIFTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIFTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIFTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIFTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIFTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIFTER actions', async () => {
      const expectedActions = [
        {
