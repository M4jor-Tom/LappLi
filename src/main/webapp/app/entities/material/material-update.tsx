...
export const MaterialUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="lappLiApp.material.home.createOrEditLabel" data-cy="MaterialCreateUpdateHeading">
            <Translate contentKey="lappLiApp.material.home.createOrEditLabel">Create or edit a Material</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
