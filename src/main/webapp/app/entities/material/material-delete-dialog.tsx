...
export const MaterialDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lappLiApp.material.delete.question">
        <Translate contentKey="lappLiApp.material.delete.question" interpolate={{ id: materialEntity.id }}>
