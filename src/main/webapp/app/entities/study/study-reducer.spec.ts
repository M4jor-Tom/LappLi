...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './study.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDY_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDY actions', async () => {
      const expectedActions = [
        {
