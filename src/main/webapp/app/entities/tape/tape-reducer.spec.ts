...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tape.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAPE actions', async () => {
      const expectedActions = [
        {
