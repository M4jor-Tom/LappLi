...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COREASSEMBLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COREASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COREASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COREASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COREASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COREASSEMBLY actions', async () => {
      const expectedActions = [
        {
