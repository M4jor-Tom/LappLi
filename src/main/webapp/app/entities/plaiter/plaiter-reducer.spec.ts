...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plaiter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAITER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAITER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAITER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAITER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAITER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAITER actions', async () => {
      const expectedActions = [
        {
