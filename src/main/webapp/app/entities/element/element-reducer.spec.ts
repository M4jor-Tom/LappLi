...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './element.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ELEMENT actions', async () => {
      const expectedActions = [
        {
