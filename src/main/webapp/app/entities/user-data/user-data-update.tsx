  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="lappLiApp.userData.home.createOrEditLabel" data-cy="UserDataCreateUpdateHeading">
            <Translate contentKey="lappLiApp.userData.home.createOrEditLabel">Create or edit a UserData</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
