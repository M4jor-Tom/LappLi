...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './carrier-plait-fiber.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRIERPLAITFIBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARRIERPLAITFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARRIERPLAITFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARRIERPLAITFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARRIERPLAITFIBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARRIERPLAITFIBER actions', async () => {
      const expectedActions = [
        {
