...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './material-marking-statistic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIALMARKINGSTATISTIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIALMARKINGSTATISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIALMARKINGSTATISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIALMARKINGSTATISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIALMARKINGSTATISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIALMARKINGSTATISTIC actions', async () => {
      const expectedActions = [
        {
