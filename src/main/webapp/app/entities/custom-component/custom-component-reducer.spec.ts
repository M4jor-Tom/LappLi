...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMCOMPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMCOMPONENT actions', async () => {
      const expectedActions = [
        {
