...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './custom-component-supply.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMCOMPONENTSUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMCOMPONENTSUPPLY actions', async () => {
      const expectedActions = [
        {
