...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYNEWCOMPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYNEWCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYNEWCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYNEWCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYNEWCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYNEWCOMPONENT actions', async () => {
      const expectedActions = [
        {
