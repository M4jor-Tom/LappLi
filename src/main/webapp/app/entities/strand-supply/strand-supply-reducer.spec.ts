...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRANDSUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRANDSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRANDSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRANDSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRANDSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRANDSUPPLY actions', async () => {
      const expectedActions = [
        {
