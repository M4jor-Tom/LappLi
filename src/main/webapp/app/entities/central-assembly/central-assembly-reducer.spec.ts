...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTRALASSEMBLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTRALASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTRALASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTRALASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTRALASSEMBLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTRALASSEMBLY actions', async () => {
      const expectedActions = [
        {
