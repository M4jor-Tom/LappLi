...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONESTUDYSUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ONESTUDYSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ONESTUDYSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ONESTUDYSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ONESTUDYSUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ONESTUDYSUPPLY actions', async () => {
      const expectedActions = [
        {
