...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAPELAYING_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAPELAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAPELAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAPELAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAPELAYING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAPELAYING actions', async () => {
      const expectedActions = [
        {
