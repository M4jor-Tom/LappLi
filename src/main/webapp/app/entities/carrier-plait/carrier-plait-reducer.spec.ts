...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRIERPLAIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARRIERPLAIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARRIERPLAIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARRIERPLAIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARRIERPLAIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARRIERPLAIT actions', async () => {
      const expectedActions = [
        {
