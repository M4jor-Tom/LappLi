...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './flat-sheathing-supply-position.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLATSHEATHINGSUPPLYPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLATSHEATHINGSUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLATSHEATHINGSUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLATSHEATHINGSUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLATSHEATHINGSUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLATSHEATHINGSUPPLYPOSITION actions', async () => {
      const expectedActions = [
        {
