...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plaiter-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAITERCONFIGURATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAITERCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAITERCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAITERCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAITERCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAITERCONFIGURATION actions', async () => {
      const expectedActions = [
        {
