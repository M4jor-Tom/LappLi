...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANGLESUPPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANGLESUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANGLESUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANGLESUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANGLESUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANGLESUPPLY actions', async () => {
      const expectedActions = [
        {
