...
@Service
@Transactional
public class OneStudySupplyServiceImpl implements OneStudySupplyService {
    ...
    public OneStudySupplyServiceImpl(OneStudySupplyRepository oneStudySupplyRepository) {
    ...
    public OneStudySupply save(OneStudySupply oneStudySupply) {
        ...
        return oneStudySupplyRepository.save(oneStudySupply);
    }
    ...
    public Optional<OneStudySupply> partialUpdate(OneStudySupply oneStudySupply) {
        ...
        return oneStudySupplyRepository
    ...
    public List<OneStudySupply> findAll() {
        ...
        return oneStudySupplyRepository.findAll();
    }
    ...
    public Optional<OneStudySupply> findOne(Long id) {
        ...
        return oneStudySupplyRepository.findById(id);
    }
