...
public class LifterRunMeasureResource {
    ...
    public LifterRunMeasureResource(LifterRunMeasureRepository lifterRunMeasureRepository) {
    ...
    public ResponseEntity<LifterRunMeasure> createLifterRunMeasure(@RequestBody LifterRunMeasure lifterRunMeasure)
        ...
        LifterRunMeasure result = lifterRunMeasureRepository.save(lifterRunMeasure);
    ...
    public ResponseEntity<LifterRunMeasure> partialUpdateLifterRunMeasure(
        ...
        Optional<LifterRunMeasure> result = lifterRunMeasureRepository
    ...
    public ResponseEntity<LifterRunMeasure> getLifterRunMeasure(@PathVariable Long id) {
        ...
        Optional<LifterRunMeasure> lifterRunMeasure = lifterRunMeasureRepository.findById(id);
